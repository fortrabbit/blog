...
intro: How we tried to test the speed benefits of the new internet protocol.
...
figure:
  src: http2-poster.gif
tag:
  - opinion
head:
  meta:
    - name: 'keywords'
      content: 'S3, AWS, object storage, HTTP2, HTTP1.1, HTTP/2, TTFB, block storage'
---
