...
intro: What you might want to know about the upcoming EOL of PHP 7.3.
...
1. Update your local development environment to at least `PHP 7.4`
...
We plan to force-update all Apps still running on `PHP 7.3` to `PHP 7.3` on the **21st of January 2022** (date is subject to change).
