...
Thanks everyone for taking the time. We have already implemented some new features based on this feedback. The survey was a fun ride, we have currently set up another more general one here: [coders-survey.com](http://coders-survey.com). And yes: We are rolling out the private BETA soon. [Download Survey Results printable PDF](/images/fortrtabbit-beta-survey-results.pdf)
