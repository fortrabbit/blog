...
author: fl
intro: IaaS, PaaS, bare metal, shared hosting, managed hosting — Quo vadis?
created: 2012-12-04
tag:
  - opinion
---
...
You are running a web shop based on Magento, osCommerce or some other open source PHP software. We are a good choice for you. As any [other](/comparing-cloud-hosting-platforms/) PHP PaaS provider, you can scale your resources based on business demands - think about Christmas sales. However, there are also great off-the-rack solutions by SaaS providers. For example: [Shopify](http://shopify.com) can host your shop. We have no experience with the service but it seems very versatile and customizable. [BigCartel](http://bigcartel.com) is another, easy to use E-commerce as a Service. 
