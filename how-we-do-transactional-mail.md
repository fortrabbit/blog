...
![Sending a test-mail from local](/dist/img/transactional-testing.png)
...
![Twig template](/dist/img/transactional-twig-template.png)

The screenshot shows part of the HTML template.

### Markdown to HTML

![Markdown example](/dist/img/transactional-markdown.png)
...
![email markup example](/dist/img/transactional-email-markup.png)
...
![Postmark screenshot](/dist/img/transactional-activity.png)
...
![Signature](/dist/img/transactional-signature.png)
...
![Gulp task to create the styles](/dist/img/transactional-gulp-task.png)
...
![Fallback rendering](/dist/img/transactional-fallback-rendering.png)
