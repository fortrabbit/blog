...
**Lee**: Ah yes, the fun stuff. Offload is built on [Laravel](http://fortrabbit.com/solutions/laravel-hosting) and uses Twillio, Stripe and a pleasant soup of other bits to make it all come together. For platform Fortrabbit was the only choice in my mind, in fact all my projects go here as I'm not interested in running the sysadmin side of things and you make it dead simple for me to do what I do, ship code. The time that I do not have to spend debugging server stuff is time I can spend writing code. **Oli**: Anything else?

**Lee**: I still do not have a fortrabbit shirt...